...
TesterFunction = ClosureEvn();

Windows = TesterFunction.new({
    Title = "Test Script",
    Description = "By Neuron X",
    ...
    RichText = '<font color="#0000FF">NeuronX</font> <font color="#FFFFFF">On Top</font>',
    BlockFrameColor = Color3.fromRGB(0, 0, 255),
    BlockTransparency = NumberSequence.new{NumberSequenceKeypoint.new(0.00, 0.00), NumberSequenceKeypoint.new(0.00, 0.00), NumberSequenceKeypoint.new(1.00, 1.00)},
    BlockTransparency2 = 0.4,
    WindowStroke = true;
});
...
MainSec1 = Main:NewSection({
    Title = "We Are NeuronX",
